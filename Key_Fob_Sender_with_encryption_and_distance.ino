...
char transmit_string[128] = "123456789010000";
char device_id[16] = "1234567890";
char switch_info[4] = "1";
char distance_data[8] = "0000";
...
static int test_encrypt_cbc(void)
{
    ...
    AES_init_ctx_iv(&ctx, key, iv);
    AES_CBC_encrypt_buffer(&ctx, in, 64);//64);
...
void transmitter() {
  ...
  Serial.println(strlen(encrypted_data));
...
int fob_transmit(int button)
{
  ...
  memcpy(tempBuff, device_id, strlen(device_id));
  //distance function has to be brought in here
  if((temp_button&0x01) == 1)
  {
    memcpy(tempBuff+strlen(tempBuff),"1",1);
    memcpy(tempBuff+strlen(tempBuff), distance_data, strlen(distance_data));
    Serial.println(tempBuff);
    memset(in,'\0',sizeof(tempBuff));
    memcpy(in,tempBuff,strlen(tempBuff));
  return 1;
     
  }
  else if((temp_button&0x02) == 0x02)
  {
    memcpy(tempBuff+strlen(tempBuff),"2",1);
    memcpy(tempBuff+strlen(tempBuff), distance_data, strlen(distance_data));
    Serial.println(tempBuff);
    memset(in,'\0',sizeof(tempBuff));
    memcpy(in,tempBuff,strlen(tempBuff));
  ...
  {
    memcpy(tempBuff+strlen(tempBuff),"4",1);
    memcpy(tempBuff+strlen(tempBuff), distance_data, strlen(distance_data));
    Serial.println(tempBuff);
    memset(in,'\0',sizeof(tempBuff));
    memcpy(in,tempBuff,strlen(tempBuff));
  ...
  {
    memcpy(tempBuff+strlen(tempBuff),"8",1);
    memcpy(tempBuff+strlen(tempBuff), distance_data, strlen(distance_data));
    Serial.println(tempBuff);
    memset(in,'\0',sizeof(tempBuff));
    memcpy(in,tempBuff,strlen(tempBuff));
